...
const currencies = ['GBP', 'USD', 'AUD', 'EUR', 'CAD']
const navigation = {
  categories: [
    {
      name: 'Menu',
            ...
            <div className="max-w-7xl mx-auto h-10 px-4 flex items-center justify-between sm:px-6 lg:px-8">
              ...
              <form className="hidden lg:block lg:flex-1">
                <div className="flex">
                  ...
                  <div className="-ml-2 group relative bg-gray-900 border-transparent rounded-md ">
                    <select
                      id="desktop-currency"
                      name="currency"
                      className="bg-none bg-vue-green border-transparent py-0.5 pl-2 pr-5 flex items-center text-sm font-medium text-white group-hover:text-gray-100 focus:outline-none focus:ring-0 focus:border-transparent"
                    >
                      {currencies.map((currency) => (
                        <option key={currency}>{currency}</option>
                      ))}
        ...
        <section aria-labelledby="trending-heading" className="bg-white">
          <div className="py-16 sm:py-24 lg:max-w-7xl lg:mx-auto lg:py-32 lg:px-8">
            <div className="px-4 flex items-center justify-between sm:px-6 lg:px-0">
              <h2 id="trending-heading" className="text-3xl font-extrabold tracking-tight text-gray-600">
                New products
              </h2>
